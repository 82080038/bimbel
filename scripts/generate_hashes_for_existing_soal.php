<?php
/**
 * Generate SHA256 hashes for all existing soal in database
 * This ensures duplicate detection works for all questions
 */
...
echo "=== Generating Hashes for Existing Soal ===\n\n";

// Get all soal without hash
$sql = "SELECT id, pertanyaan FROM soal WHERE id NOT IN (SELECT soal_id FROM soal_duplicate_check)";
