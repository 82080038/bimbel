<?php
// Content Management Database Migration Script
// Run this file to create content management tables

require_once 'config.php';

checkDatabaseConnection();

echo "Starting Content Management Database Migration...\n";

// Read SQL file
$sqlFile = __DIR__ . '/database/content_management.sql';
