<?php
// Notification System Database Migration Script
// Run this file to create notification tables

require_once 'config.php';

checkDatabaseConnection();

echo "Starting Notification System Database Migration...\n";

// Read SQL file
$sqlFile = __DIR__ . '/database/notifications.sql';
