...
$protection->applyRateLimit('auth'); // Stricter rate limit for login (10/min)
// Disabled suspicious activity check for login to prevent blocking during development
