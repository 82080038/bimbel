...
foreach ($twk_questions as $q) {
    ...
    $stmt->bind_param("issssssss", $q['kategori_id'], $q['pertanyaan'], $q['opsi_a'], $q['opsi_b'], $q['opsi_c'], $q['opsi_d'], $q['opsi_e'], $q['jawaban_benar'], $q['pembahasan'], $q['tips']);
    $stmt->execute();
}

// Insert TIU questions
...
echo "<br>TWK: " . count($twk_questions) . " questions";
echo "<br>TIU: " . count($tiu_questions) . " questions";
echo "<br>TKP: " . count($tkp_questions) . " questions";
?>
