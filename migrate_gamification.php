<?php
// Gamification Database Migration Script
// Run this file to create gamification tables

require_once 'config.php';

checkDatabaseConnection();

echo "Starting Gamification Database Migration...\n";

// Read SQL file
$sqlFile = __DIR__ . '/database/gamification.sql';
