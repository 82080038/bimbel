...
// Access via: http://localhost/bimbel/migrate_bahan_topic_web.php
// Date: 2026-05-26
...
try {
    ...
    $check = $conn->query("SHOW COLUMNS FROM bahan_pelajaran LIKE 'topic_id'");
    if ($check->num_rows > 0) {
        echo "topic_id column already exists in bahan_pelajaran table\n";
        exit;
    }
