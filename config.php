...
// Official passing grades from MENPAN (Keputusan Menteri PANRB No. 651/2023):
// TWK: 65 (30 soal), TIU: 80 (35 soal), TKP: 166 (45 soal), Total: 550
// For simulations with fewer questions, grades are proportionally adjusted
if (!defined('PASSING_GRADE_TWK')) {
    define('PASSING_GRADE_TWK', 65);  // Official MENPAN passing grade for TWK
}
if (!defined('PASSING_GRADE_TIU')) {
    define('PASSING_GRADE_TIU', 80);  // Official MENPAN passing grade for TIU
}
if (!defined('PASSING_GRADE_TKP')) {
    define('PASSING_GRADE_TKP', 166); // Official MENPAN passing grade for TKP
}
if (!defined('PASSING_GRADE_TPA')) {
    define('PASSING_GRADE_TPA', 0);   // Not applicable for SKD (used for TPA/UTBK)
}
if (!defined('PASSING_GRADE_PSIKOLOGIS')) {
    define('PASSING_GRADE_PSIKOLOGIS', 0); // Not applicable for SKD (used for psikotes)
}
if (!defined('PASSING_GRADE_TOTAL')) {
    define('PASSING_GRADE_TOTAL', 550); // Official MENPAN cumulative passing grade
}
?>
